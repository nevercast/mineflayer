...
var entityStatusEvents = {
  ...
  9: 'entityEatingAccepted',
  10: 'entityEatingGrass',
  11: 'entityOfferRose',
  12: 'entityHeartParticles',
  13: 'entityRevengeParticles',
  14: 'entityHappyParticles',
  15: 'entityMagicParticles',
  16: 'entityUnZombify',
  17: 'entityFireworkExplode',
};
...
var spawnedObjectTypes = {
  ...
  63: 'fireballProjectile',
  62: 'eggProjectile',
  64: 'fireChargeProjectile',
  65: 'thrownEnderpearl',
  66: 'witherSkull',
  70: 'fallingObjects',
  71: 'itemFrames',
...
function inject(bot) {
  ...
  bot.client.on(0x04, function(packet) {
    // entity equipment
  ...
  bot.client.on(0x0a, function(packet) {
    // use bed
    var entity = fetchEntity(packet.entityId);
  ...
  bot.client.on(0x0b, function(packet) {
    // animation
    var entity = fetchEntity(packet.entityId);
  ...
  bot.client.on(0x0c, function(packet) {
    // spawn player
    var entity = fetchEntity(packet.entityId);
    entity.type = 'player';
  ...
  bot.client.on(0x0e, function(packet) {
    // spawn object
    var entity = fetchEntity(packet.entityId);
    entity.type = 'object';
  ...
  bot.client.on(0x0f, function(packet) {
    // spawn mob
    var entity = fetchEntity(packet.entityId);
    entity.type = 'mob';
  ...
  bot.client.on(0x13, function(packet) {
    // destroy entity
  ...
  bot.client.on(0x15, function(packet) {
  ...
  bot.client.on(0x1b, function(packet) {
    // attach entity
    var entity = fetchEntity(packet.entityId);
    // TODO: handle leash property?
  ...
  bot.client.on(0x1e, function(packet) {
  ...
  bot.client.on(0x2c, function(packet) {
    // spawn global entity
    var entity = fetchEntity(packet.entityId);
    entity.type = 'global';
  ...
  function useEntity(target, leftClick) {
    bot.client.write(0x02, {
      target: target.id,
      leftClick: leftClick ? 0 : 1,
    });
  }
